...
class ICD_Tests(object):
    def __init__(self,client):
        self.api_client = client

    @assignOrder(1)
    def Reg_Create_ICD_order(self):
        test_case_result = TestCase(name="Reg_Create_ICD_order", classname=self.__class__.__name__)
        ...
        try:
            for i in range(1, 2):
                ...
                serviceInstanceName = "testAPIICd" + epoch_time
