...
class VRA_Tests(object):
    def __init__(self,client):
        self.api_client = client

    @assignOrder(1)
    def VRA_Create_Order(self):
        global service_id, resource_id
        passed = False
        service_id, resource_id = self.api_client.getResourcetoRunTest("vra", "buyer", "CORE-X")
        # service_id, resource_id = self.api_client.getResourcetoRunTest("vra","buyer", teamName="mTeam")
        # service_id, resource_id = self.api_client.createAndApproveOrder(headers, "VRA", "buyer", teamName_buyer)
    ...
    @assignOrder(2)
    def VRA_On_Edit_SOI_Request_status(self):
        global service_id
        passed = False
    ...
    @assignOrder(3)
    def VRA_On_Edit_SOI_valid_data_status(self):
        global service_id
        passed = False
        url = EditSOI_URL + service_id
    ...
    # @assignOrder(4)
    # def VRA_view_properties_responsetime(self):
    #     global service_id
    #     passed = False
    ...
    @assignOrder(5)
    def VRA_view_properties_validate_responsedata(self):
        global service_id
        passed = False
    ...
    @assignOrder(6)
    def VRA_Order_History__responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(7)
    def VRA_Order_History_valid_data(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    @assignOrder(8)
    def VRA_Order_History_instances(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    # @assignOrder(9)
    # def VRA_Get_operation_state_of_resource_responsetime(self):
    #     global service_id, resource_id
    #     passed = False
    #     print "Expected Response Time : " + ResponseTime
    ...
    @assignOrder(10)
    def VRA_checkServiceFulfillmentId_serviceListingAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
    ...
    @assignOrder(11)
    def VRA_checkServiceFulfillmentId_viewPropertiesAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
        # sid = config.get('resources', 'service_id1')
    ...
    @assignOrder(12)
    def VRA_Create_New_Operation_Execution_Request_responsetime(self):
        global service_id, resource_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        body = {
    ...
    # @assignOrder(13)
    # def VRA_Create_New_Operation_Execution_Reboot_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    #
    # @assignOrder(14)
    # def VRA_Create_New_Operation_Execution_Off_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    # @assignOrder(15)
    # def VRA_Create_New_Operation_Execution_On_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOn = False
    #     turningOnState = False
    ...
    @assignOrder(16)
    def VRA_Get_operation_state_of_operation_responsetime(self):
        global resource_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    # @assignOrder(17)
    # def VRA_Get_operation_state_of_resource_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     resp, body, roundtrip = self.api_client.get_api_response_time(
    #         resourceStateURL + "/" + resource_id + "state?provider_id=" + provider + "&SID=" + service_id)
    ...
    #
    # @assignOrder(18)
    # def VRA_Get_operation_state_of_operation_ValidateTags(self):
    #     global resource_id
    #     passed = False
    ...
    @assignOrder(27)
    def VRA_API_SOI_Delete_Request_responsetime(self):
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        body = {
    ...
    @assignOrder(28)
    def VRA_List_Service_Details_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(29)
    def VRA_List_Service_Details_By_ServiceId_valid_data(self):
        global service_id
        passed = False
    ...
    @assignOrder(30)
    def VRA_API_OperationRegistryList_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        resp, body, roundtrip = self.api_client.get_api_response_time(
    ...
    @assignOrder(31)
    def VRA_API_OperationRegistryList_By_ServiceId_valid_data(self):
        global service_id
        passed = False
        resp, body, roundtrip = self.api_client.get_all_tags_data(
            componentURL + "/" + provider + "/" + service_id)
    ...
    @assignOrder(33)
    def VRA_SOI_Delete_valid_data_singleSID(self):
    ...
    # # @assignOrder(34)
    # # def VRA_DeleteV2_Audit_Logging(self):
    # #     passed = False
