...
class AZURE_Tests(object):
    def __init__(self,client):
        self.api_client = client

    @assignOrder(1)
    def azure_Create_Order(self):
        global service_id, resource_id
        passed = False
        service_id, resource_id = self.api_client.getResourcetoRunTest("azure", "buyer", "CORE-X")
        # service_id, resource_id = self.api_client.getResourcetoRunTest("azure","buyer", teamName="mTeam")
        # service_id, resource_id = self.api_client.createAndApproveOrder(headers, "azure", "buyer", teamName_buyer)
    ...
    @assignOrder(2)
    def azure_On_Edit_SOI_Request_status(self):
        global service_id
        passed = False
    ...
    @assignOrder(3)
    def azure_On_Edit_SOI_valid_data_status(self):
        global service_id
        passed = False
        url = EditSOI_URL + service_id
    ...
    @assignOrder(4)
    def azure_view_properties_responsetime(self):
        global service_id
        passed = False
    ...
    @assignOrder(5)
    def azure_view_properties_validate_responsedata(self):
        global service_id
        passed = False
    ...
    @assignOrder(6)
    def azure_Order_History__responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(7)
    def azure_Order_History_valid_data(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    @assignOrder(8)
    def azure_Order_History_instances(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    # @assignOrder(9)
    # def azure_Get_operation_state_of_resource_responsetime(self):
    #     global service_id, resource_id
    #     passed = False
    #     print "Expected Response Time : " + ResponseTime
    ...
    @assignOrder(10)
    def azure_checkServiceFulfillmentId_serviceListingAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
    ...
    @assignOrder(11)
    def azure_checkServiceFulfillmentId_viewPropertiesAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
        # sid = config.get('resources', 'service_id1')
    ...
    # @assignOrder(12)
    # def azure_Create_New_Operation_Execution_Request_responsetime(self):
    #     global service_id, resource_id
    #     passed = False
    #     print ("Expected Response Time : " + ResponseTime)
    #     body = {
    ...
    # @assignOrder(13)
    # def azure_Create_New_Operation_Execution_Reboot_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    #
    # @assignOrder(14)
    # def azure_Create_New_Operation_Execution_Off_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    # @assignOrder(15)
    # def azure_Create_New_Operation_Execution_On_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOn = False
    #     turningOnState = False
    ...
    @assignOrder(16)
    def azure_Get_operation_state_of_operation_responsetime(self):
        global resource_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    # @assignOrder(17)
    # def azure_Get_operation_state_of_resource_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     resp, body, roundtrip = self.api_client.get_api_response_time(
    #         resourceStateURL + "/" + resource_id + "state?provider_id=" + provider + "&SID=" + service_id)
    ...
    #
    # @assignOrder(18)
    # def azure_Get_operation_state_of_operation_ValidateTags(self):
    #     global resource_id
    #     passed = False
    ...
    @assignOrder(27)
    def azure_API_SOI_Delete_Request_responsetime(self):
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        body = {
    ...
    @assignOrder(28)
    def azure_List_Service_Details_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(29)
    def azure_List_Service_Details_By_ServiceId_valid_data(self):
        global service_id
        passed = False
    ...
    @assignOrder(30)
    def azure_API_OperationRegistryList_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        resp, body, roundtrip = self.api_client.get_api_response_time(
    ...
    @assignOrder(31)
    def azure_API_OperationRegistryList_By_ServiceId_valid_data(self):
        global service_id
        passed = False
        resp, body, roundtrip = self.api_client.get_all_tags_data(
            componentURL + "/" + provider + "/" + service_id)
    ...
    #
    @assignOrder(33)
    def azure_SOI_Delete_valid_data_singleSID(self):
    ...
    # # @assignOrder(34)
    # # def azure_DeleteV2_Audit_Logging(self):
    # #     passed = False
