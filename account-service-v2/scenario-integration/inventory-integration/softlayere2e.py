...
class Softlayer_Tests(object):
    def __init__(self,client):
        self.api_client = client

    @assignOrder(1)
    def SOFTLAYER_Create_Order(self):
        global service_id, resource_id
        passed = False
        service_id, resource_id = self.api_client.getResourcetoRunTest("softlayer", "buyer", "CORE-X")
    ...
    @assignOrder(2)
    def SOFTLAYER_On_Edit_SOI_Request_status(self):
        global service_id
        passed = False
    ...
    @assignOrder(3)
    def SOFTLAYER_On_Edit_SOI_valid_data_status(self):
        global service_id
        passed = False
        url = EditSOI_URL + service_id
    ...
    @assignOrder(4)
    def SOFTLAYER_view_properties_responsetime(self):
        global service_id
        passed = False
    ...
    @assignOrder(5)
    def SOFTLAYER_view_properties_validate_responsedata(self):
        global service_id
        passed = False
    ...
    @assignOrder(6)
    def SOFTLAYER_Order_History__responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(7)
    def SOFTLAYER_Order_History_valid_data(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    @assignOrder(8)
    def SOFTLAYER_Order_History_instances(self):
        global service_id
        passed = False
        url = order_historyURL + "/" + service_id
    ...
    # @assignOrder(9)
    # def SOFTLAYER_Get_operation_state_of_resource_responsetime(self):
    #     global service_id, resource_id
    #     passed = False
    #     print "Expected Response Time : " + ResponseTime
    ...
    @assignOrder(10)
    def SOFTLAYER_checkServiceFulfillmentId_serviceListingAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
    ...
    @assignOrder(11)
    def SOFTLAYER_checkServiceFulfillmentId_viewPropertiesAPI(self):
        global service_id
        passed = False
        # config.read('testdata.conf')
        # sid = config.get('resources', 'service_id1')
    ...
    # @assignOrder(12)
    # def SOFTLAYER_Create_New_Operation_Execution_Request_responsetime(self):
    #     global service_id, resource_id
    #     passed = False
    #     print ("Expected Response Time : " + ResponseTime)
    #     body = {
    ...
    # @assignOrder(13)
    # def SOFTLAYER_Create_New_Operation_Execution_Reboot_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    #
    # @assignOrder(14)
    # def SOFTLAYER_Create_New_Operation_Execution_Off_valid_data(self):
    #     global service_id, resource_id
    #     passed = False
    #     alreadyOff = False
    ...
    @assignOrder(15)
    def SOFTLAYER_Create_New_Operation_Execution_On_valid_data(self):
        global service_id, resource_id
        passed = False
        alreadyOn = False
        turningOnState = False
    ...
    @assignOrder(16)
    def SOFTLAYER_Get_operation_state_of_operation_responsetime(self):
        global resource_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(17)
    def SOFTLAYER_Get_operation_state_of_resource_valid_data(self):
        global service_id, resource_id
        passed = False
        resp, body, roundtrip = self.api_client.get_api_response_time(
            resourceStateURL + "/" + resource_id + "/state?provider_id=" + provider + "&SID=" + service_id)
    ...
    # @assignOrder(18)
    # def SOFTLAYER_Get_operation_state_of_operation_ValidateTags(self):
    #     global resource_id
    #     passed = False
    ...
    @assignOrder(27)
    def SOFTLAYER_API_SOI_Delete_Request_responsetime(self):
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        body = {
    ...
    @assignOrder(28)
    def SOFTLAYER_List_Service_Details_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
    ...
    @assignOrder(29)
    def SOFTLAYER_List_Service_Details_By_ServiceId_valid_data(self):
        global service_id
        passed = False
    ...
    @assignOrder(30)
    def SOFTLAYER_API_OperationRegistryList_By_ServiceId_responsetime(self):
        global service_id
        passed = False
        print ("Expected Response Time : " + ResponseTime)
        resp, body, roundtrip = self.api_client.get_api_response_time(
    ...
    @assignOrder(31)
    def SOFTLAYER_API_OperationRegistryList_By_ServiceId_valid_data(self):
        global service_id
        passed = False
        resp, body, roundtrip = self.api_client.get_all_tags_data(
            componentURL + "/" + provider + "/" + service_id)
    ...
    @assignOrder(33)
    def SOFTLAYER_SOI_Delete_valid_data_singleSID(self):
    ...
    # @assignOrder(34)
    # def SOFTLAYER_DeleteV2_Audit_Logging(self):
    #     passed = False
    #     global service_id
    ...
    #     print (resp)SOFTLAYER_Get_operation_state_of_operation_ValidateTags
    #     print (body_audit)
    #     passOfResponseCode = assertEqual(resp, 200)
    #     if (passOfResponseCode):
    ...
    #                     if (body_audit["result"][i]["message"]).find(service_id) > -1 and str(
    #                             body_audit["result"][i]["message"]).find('Delete Service From Inventory') > -1:
    #                         passed = True
    #                     break
    #                 else:
